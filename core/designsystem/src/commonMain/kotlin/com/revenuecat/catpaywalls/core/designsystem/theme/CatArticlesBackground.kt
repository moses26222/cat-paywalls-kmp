...
@Immutable
data class CatArticlesBackground(val color: Color = Color.Unspecified, val tonalElevation: Dp = Dp.Unspecified) {
  companion object {
    private val backgroundLight = Color(0xFFF4EBF4)
    private val backgroundDark = Color(0xFF2B292B)

    fun defaultBackground(darkTheme: Boolean): CatArticlesBackground = if (darkTheme) {
